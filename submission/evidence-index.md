...
| User onboarding spreadsheet | [`user-feedback-sheet-updated.png`](user-feedback-sheet-updated.png) | Supplied Excel/Sheets-style evidence image showing 12 visible response rows; contains sensitive personal fields and should not be redistributed beyond authorized review. |
