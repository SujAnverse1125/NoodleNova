...
| Admin-panel user onboarding | [`admin-panel-user-onboarding.png`](admin-panel-user-onboarding.png) and [`admin-panel-feedback.png`](admin-panel-feedback.png) | Supplied admin screenshots showing 69 registered couriers, 40 transaction-log entries, and 69 feedback records; use as private/sensitive operational evidence. |
...
| Website interactions | [`admin-panel-user-onboarding.png`](admin-panel-user-onboarding.png), [`admin-panel-feedback.png`](admin-panel-feedback.png), authorized admin panel, and [`interaction-evidence.md`](interaction-evidence.md) | Screenshots show the registered-user list, 40-entry transaction log, and 69 feedback records; full hashes and the 10-interaction claim remain pending verification. Do not publish the admin token or private admin URL. |
